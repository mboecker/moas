...
#[test]
fn cid_78961() {
    let j = r#"{"atoms": [[1, 6, 0], [2, 6, 0], [3, 6, 0], [4, 6, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 1, 0], [9, 1, 0], [10, 1, 0], [11, 1, 0], [12, 1, 0], [13, 1, 0], [14, 1, 0], [15, 1, 0]], "bonds": [[1, 3, 1], [1, 4, 1], [1, 6, 1], [1, 10, 1], [2, 3, 1], [2, 4, 1], [2, 5, 1], [2, 9, 1], [3, 6, 1], [3, 8, 1], [4, 5, 1], [4, 11, 1], [5, 7, 1], [5, 13, 1], [6, 7, 1], [6, 12, 1], [7, 14, 1], [7, 15, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[test]
fn cid_129629785() {
    let j = r#"{"atoms": [[1, 16, 0], [2, 8, 0], [3, 8, 0], [4, 8, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 6, 0], [9, 6, 0], [10, 6, 0], [11, 1, 0], [12, 1, 0], [13, 1, 0], [14, 1, 0]], "bonds": [[1, 8, 1], [1, 13, 1], [2, 5, 1], [2, 6, 1], [3, 7, 1], [3, 12, 1], [4, 10, 1], [4, 14, 1], [5, 7, 1], [5, 8, 2], [6, 7, 2], [6, 9, 1], [8, 10, 1], [9, 10, 2], [9, 11, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 8);
