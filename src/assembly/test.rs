...
#[test]
fn cid_44155377() {
    let j = r#"{"atoms": [[1, 8, 0], [2, 7, 0], [3, 6, 0], [4, 6, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 6, 0], [9, 1, 0], [10, 1, 0], [11, 1, 0], [12, 1, 0], [13, 1, 0], [14, 1, 0], [15, 1, 0]],
                "bonds": [[1, 7, 2], [2, 4, 1], [2, 7, 1], [2, 12, 1], [3, 4, 1], [3, 5, 1], [3, 7, 1], [3, 9, 1], [4, 6, 1], [4, 10, 1], [5, 6, 2], [5, 8, 1], [6, 11, 1], [8, 13, 1], [8, 14, 1], [8, 15, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[test]
fn cid_85823385() {
    let j = r#"{"atoms": [[1, 7, 0], [2, 7, 0], [3, 7, 0], [4, 7, 0], [5, 7, 0], [6, 7, 0], [7, 7, 0], [8, 7, 0], [9, 7, 0], [10, 7, 0], [11, 7, 0], [12, 7, 0]],
                "bonds": [[1, 2, 1], [1, 3, 1], [1, 4, 1], [2, 5, 1], [2, 6, 1], [3, 5, 1], [3, 7, 1], [4, 6, 1], [4, 8, 1], [5, 9, 1], [6, 10, 1], [7, 9, 1], [7, 11, 1], [8, 10, 1], [8, 11, 1], [9, 12, 1], [10, 12, 1], [11, 12, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[test]
fn cid_85866647() {
    let j = r#"{"atoms": [[1, 15, 1], [2, 15, 0], [3, 15, 0], [4, 6, 0], [5, 6, 0], [6, 1, 0], [7, 1, 0]],
                "bonds": [[1, 2, 1], [1, 3, 1], [1, 4, 1], [1, 5, 1], [2, 4, 1], [2, 5, 1], [3, 4, 1], [3, 5, 1], [4, 6, 1], [5, 7, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[ignore]
fn cid_123319635() {
    let j = r#"{"atoms": [[1, 6, 0], [2, 6, 0], [3, 6, 0], [4, 6, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 6, 0], [9, 1, 0], [10, 1, 0], [11, 1, 0], [12, 1, 0], [13, 1, 0], [14, 1, 0], [15, 1, 0], [16, 1, 0], [17, 1, 0], [18, 1, 0]],
                "bonds": [[1, 2, 1], [1, 4, 1], [1, 5, 1], [1, 7, 1], [2, 3, 1], [2, 4, 1], [2, 9, 1], [3, 5, 1], [3, 6, 1], [3, 8, 1], [4, 6, 1], [4, 10, 1], [5, 11, 1], [5, 12, 1], [6, 13, 1], [6, 14, 1], [7, 8, 1], [7, 15, 1], [7, 16, 1], [8, 17, 1], [8, 18, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[ignore]
fn cid_21350970() {
    let j = r#"{"atoms": [[1, 6, 0], [2, 6, 0], [3, 6, 0], [4, 6, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 6, 0], [9, 1, 0], [10, 1, 0], [11, 1, 0], [12, 1, 0], [13, 1, 0], [14, 1, 0]],
                "bonds": [[1, 2, 1], [1, 3, 1], [1, 4, 1], [1, 5, 1], [2, 3, 1], [2, 4, 1], [2, 6, 1], [3, 5, 1], [3, 7, 1], [4, 6, 1], [4, 8, 1], [5, 7, 1], [5, 9, 1], [6, 8, 1], [6, 10, 1], [7, 11, 1], [7, 12, 1], [8, 13, 1], [8, 14, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
fn cid_101178162() {
    let j = r#"{"atoms": [[1, 7, 0], [2, 7, 0], [3, 7, 0], [4, 7, 0], [5, 7, 0], [6, 7, 0], [7, 7, 0], [8, 7, 0], [9, 7, 0], [10, 7, 0], [11, 7, 0], [12, 7, 0]],
                "bonds": [[1, 4, 1], [1, 5, 1], [1, 7, 1], [2, 3, 1], [2, 6, 1], [2, 8, 1], [3, 6, 1], [3, 9, 1], [4, 5, 1], [4, 10, 1], [5, 11, 1], [6, 12, 1], [7, 8, 1], [7, 9, 1], [8, 10, 1], [9, 11, 1], [10, 12, 1], [11, 12, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[test]
fn cid_85608278() {
    let j = r#"{"atoms": [[1, 7, 0], [2, 7, 0], [3, 7, 0], [4, 7, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 6, 0], [9, 1, 0], [10, 1, 0], [11, 1, 0], [12, 1, 0]],
                "bonds": [[1, 6, 1], [1, 7, 1], [1, 8, 1], [2, 4, 1], [2, 6, 1], [2, 8, 1], [3, 4, 1], [3, 7, 1], [3, 8, 1], [4, 5, 1], [5, 6, 1], [5, 7, 1], [5, 9, 1], [6, 10, 1], [7, 11, 1], [8, 12, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[ignore]
fn cid_59256090() {
    let j = r#"{"atoms": [[1, 6, 0], [2, 6, 0], [3, 6, 0], [4, 6, 0], [5, 6, 0], [6, 6, 0], [7, 6, 0], [8, 6, 0], [9, 6, 0], [10, 6, 0]],
                "bonds": [[1, 2, 1], [1, 3, 1], [1, 4, 1], [1, 5, 1], [2, 3, 1], [2, 5, 1], [2, 6, 1], [3, 4, 1], [3, 7, 1], [4, 7, 1], [4, 8, 1], [5, 6, 1], [5, 9, 1], [6, 9, 1], [6, 10, 1], [7, 8, 1], [7, 10, 1], [8, 9, 1], [8, 10, 1], [9, 10, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
...
#[test]
fn cid_85779440() {
    let j = r#"{"atoms": [[1, 7, 0], [2, 6, 0], [3, 6, 0], [4, 6, 0], [5, 6, 0], [6, 6, 0], [7, 1, 0], [8, 1, 0], [9, 1, 0], [10, 1, 0], [11, 1, 0]],
                "bonds": [[1, 4, 1], [1, 5, 1], [1, 6, 1], [2, 3, 1], [2, 4, 1], [2, 5, 1], [2, 7, 1], [3, 4, 1], [3, 6, 1], [3, 8, 1], [4, 9, 1], [5, 6, 1], [5, 10, 1], [6, 11, 1]]}"#;
    let gs = test_assembly(j);
    assert_eq!(gs.len(), 1);
}
